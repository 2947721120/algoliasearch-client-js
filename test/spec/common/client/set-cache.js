...
test('providing a cache when initializing', function(t) {
  ...
  var cacheKey = '/1/indexes/' + credentials.indexName + '/query_body_{"params":"query=' + searchTerm + '"}';
  var cache = {};
  ...
  var indexWithCache = searchWithCache.initIndex(credentials.indexName);

  fauxJax.on('request', function(req) {
    req.respond(200, {}, cachedResult);
  });

  indexWithCache.search(searchTerm, end);
